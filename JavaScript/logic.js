const pages = [
    {
        ...
        title_2: "Первые шаги",
        text_1: "Экран по умолчанию показывает \"0.\"",
    ...
    },
    {
        ...
        title_2: "Lg, Ln, eˣ, yˣ",
        text_1: "lg — десятичный (log₁₀), ln — натуральный (logₑ). eˣ вычисляет exp.",
        text_2: "yˣ возводит в степень: введите основание y → нажмите yˣ → введите степень x → нажмите =",
        text_3: "",
        text_4: "",
    },
    {
        ...
        title_2: "√, 1/x, ρ",
        text_1: "√ извлекает квадратный корень. 1/x вычисляет обратную величину. Примеры: нажмите 1 → нажмите 6 → нажмите √ → нажмите = → результат: 4; нажмите 5 → нажмите 1/x → нажмите = → результат: 0.2.",
        text_2: "/ρ/ вычисляет √(x² + y²): введите первое число → /ρ/ → второе число → =. Пример: 3 /ρ/ 4 = 5 (теорема Пифагора).",
        text_3: "",
        text_4: "",
    },
    {
